...
if ($_SERVER['REQUEST_METHOD']=='POST'&& isset($_POST['verify'])) {
     $userLog=$admin->verifyAccount($_POST);
 }
 ?>
<!DOCTYPE html>
                ...
                <div class="card-body">
                    ...
                    <form action=""  method="post">
                        <div class="form-group">
                            <label class="form-label" for="password">Enter Your Code:</label>
                            <div class="input-group input-group-merge">
                                <input id="password" type="text"  class="form-control form-control-prepended" name="code" placeholder="Your Code" required="required">

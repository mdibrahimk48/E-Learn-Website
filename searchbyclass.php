...
<?php 
if (!isset($_GET['classId'])||$_GET['classId']==NULL ||$_GET['classId']!=$_GET['classId']) {
    echo "<script>window.location = '404.php';</script>";
}else{
    // $id=$_GET['classId'];
    $searchid=preg_replace('/[^-a-zA-Z0-9_]/', '', $_GET['classId']);
}
 ?>
<!-- End Header Style -->
            ...
            <div class="courses__content__wrap mt--20 list__view__page">
                ...
                <div role="tabpanel" class="single__grid__view clearfix tab-pane fade in active" id="grid-view">
                    <div class="row">
                        ...
                        <?php 
                            $getCourses=$course->searchCourses($searchid);
                            if ($getCourses) {

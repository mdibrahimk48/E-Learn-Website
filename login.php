                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="text-center">
                                                        <a href="password-forget.php" tabindex="5" class="forgot-password">Forgot Password?</a>
                                                        <span class="pull-right">
                                                        <a href="index.php" tabindex="5" class="forgot-password">Home</a>
                                    ...
                                    <form id="register-form" action="" method="post" role="form" style="display: none;">
                                        <div class="form-group">
                                            <input type="text" name="name" id="username" tabindex="1" class="form-control" placeholder="Your name" required="required">
                                        </div>
                                        <div class="form-group">
                                            <input type="tel" name="mobile" id="username" tabindex="1" class="form-control" placeholder="Your Number" required="required">
                                        </div>
                                        <div class="form-group">
                                            <input type="email" name="email" id="username" tabindex="1" class="form-control" placeholder="Your Email" required="required">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="school" id="username" tabindex="1" class="form-control" placeholder="Your school/collage" required="required">
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" id="sel1" name="class" required="required">
                                        ...
                                        <div class="form-group ">
                                            <label class="control-label">Gender : </label>&nbsp&nbsp
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <button type="submit" class="form-control btn btn-default btn-block" name="registration">Register an Account</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
